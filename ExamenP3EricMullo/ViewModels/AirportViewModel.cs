...
namespace ExamenP3EricMullo.ViewModels
{
    public class AirportViewModel : INotifyPropertyChanged
    {
        ...
        {
            airport =  await App.apiRepository.GetResponseAPI(currentNameAirport);
        ...
        public void SaveInSQLite()
        {
            if (airport != null)
            {
                ...
                bool validation = App.airportRepository.AddNewAirport(supportedAirport);
